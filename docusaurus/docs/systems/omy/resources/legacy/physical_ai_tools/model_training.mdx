...
Once [preparing your dataset](/docs/systems/omy/resources/legacy/physical_ai_tools/dataset_preparation) is done, the policy model can be trained using either the Web UI or the LeRobot CLI.
...
(Refer to the [Dataset Preparation > Web UI > 1. Open the Web UI](/docs/systems/omy/resources/legacy/physical_ai_tools/dataset_preparation/recording#_1-open-the-web-ui) for more details.)
