...
<div class="UI" style={{width: '80%', margin: '0 auto'}}>
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/url_omy.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
- Once accessed, the following screen will appear with the `Disconnected` status.
  ...
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/initial_page.png" alt="Web UI" style={{width: '100%'}} />
...
<div class="UI" style={{width: '60%', margin: '0 auto'}}>
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/robot_type_selection.png" alt="Web UI" style={{width: '100%'}} />
</div>

After clicking the `Set Robot Type` button, the status will change to `Connected`.
<div class="UI" style={{width: '60%', margin: '0 auto'}}>
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/connected_omx_f.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/page.png" alt="Web UI" style={{width: '100%'}} />
...
2. Choose a topic from the popup window.
  ...
  <div class="UI" style={{width: '60%', margin: '0 auto'}}>
  <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/select_image_topic.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<div style={{display: 'flex', justifyContent: 'center', gap: '40px'}}>
  <div style={{textAlign: 'center'}}>
    <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/task_info_filled.png" alt="Web UI" style={{width: '95%', maxWidth: '300px'}} />
...
<div style={{display: 'flex', justifyContent: 'center', gap: '40px'}}>
  <div style={{textAlign: 'center'}}>
    <img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/task_info_multi_task_filled.png" alt="Web UI" style={{width: '95%', maxWidth: '300px'}} />
    <p><em>Filled Panel</em></p>
  </div>
</div>
...
<img src="/img/systems/omx/imitation_learning/physical_ai_tools/dataset_preparation/recording/control_panel_multi_task.png" alt="Web UI" style={{width: '100%'}} />
