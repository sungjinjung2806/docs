...
[Set up Physical AI Tools Docker Container](/docs/systems/omx/resources/legacy/physical_ai_tools/dataset_preparation/prerequisites#setup-physical-ai-tools-docker-container)
...
(Refer to the [Dataset Preparation > Recording > 1. Open the Web UI](/docs/systems/omx/resources/legacy/physical_ai_tools/dataset_preparation/recording#_1-open-the-web-ui))
