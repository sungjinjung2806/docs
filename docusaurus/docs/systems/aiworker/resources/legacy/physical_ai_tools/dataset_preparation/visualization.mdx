...
```
  ...
  <img src="/img/systems/aiworker/imitation_learning/dataset_preparation/visualization/task_info_repo_id_ffw.png" alt="Web UI" style={{width: '100%'}} />
</div>
...
<img src="/img/systems/aiworker/imitation_learning/dataset_preparation/visualization/data_visualization.png" alt="Web UI" style={{width: '100%'}} />
